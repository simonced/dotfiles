...
;; not searching in invisible text with isearch, I leave that to swipper
...
;; ivy (I don't use it...)
										;(ivy-mode 1) ;; I don't like ivy replacing tags selections in org-mode
...
;; GREP RELATED ===
;; the setting above doesn't seem to work
...
;; closing code blocks by default, like outlines
;; (setq org-hide-block-startup t)
...
(defun ced/org-mode-hook ()
  ...
  (org-babel-do-load-languages
   ...
   '((emacs-lisp . t) (sql . t) (js . t) (plantuml . t) (shell . t) (ruby . t) (js . t) (elixir . t))) ;(gnuplot . t)
  ...
  ;; Hl-line not really nice in org documents
  (hl-line-mode -1)
